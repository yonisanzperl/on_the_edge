...
#SBATCH --array=1-50
#SBATCH --output=S_IC_sub%A_%a.out
#SBATCH --error=S_IC_sub%A_%a.err
...
save(sprintf('Wtrials_forz_sub_node_redo_sincos2Noise_%03d.mat',s),'infocapacity','susceptibility','NSUBSIM');
