#!/bin/bash
#SBATCH --job-name=PertSuper
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem-per-cpu=2G
#SBATCH --cpus-per-task=2
#SBATCH --array=1-273
#SBATCH --output=PertuSup_v1%A_%a.out
#SBATCH --error=PertuSup_v1%A_%a.err
...
%%%
save(sprintf('PertSup68_op_%03d.mat',s),'GBCfitt1','GBCfitt2','FCfitt','FCfitt2', 'FCDfitt','Metafitt');
